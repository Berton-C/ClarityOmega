...
VERSION = "v08.7.1-hyperseed-durability-completion-v01.4-container-tmp-runtime"
...
def stage_artifacts_to_container(container: str, engine: Path, ladder: Path, tmp_dir: str) -> Tuple[bool, Dict[str, Any]]:
    ...
    engine_dst = f"{tmp_dir.rstrip('/')}/v08_7_1_engine_under_test.metta"
    ladder_dst = f"{tmp_dir.rstrip('/')}/v08_7_1_ladder_under_test.metta"
