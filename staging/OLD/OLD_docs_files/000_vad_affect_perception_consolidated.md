...
**Status:** Consolidation of the VAD workstream from `shared_files/` and `shared_files/repos/omega_archive/`, read end to end 2026-07-17. This document is the single entry point for the VAD programme; the source files remain where they are until a curation pass promotes them.
