...
def run_unified_v3(metta_fn=None):
    ...
    save_meta(goal_count=14, exchange_count=0, notes='v3 runtime with MeTTa compass')
    result = {'situation': situation, 'compass': compass, 'persisted': True, 'engine': 'metta-nal'}
